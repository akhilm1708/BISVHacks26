    ...
    try {
      ...
      intervalRef.current = setInterval(async () => {
        ...
        try {
          ...
          if (!res.ok) {
            // If Deepgram rejects this chunk, just skip it so the stream continues smoothly.
            return
          }
          ...
          if (data.analysis) {
            setResult(data.analysis as ScamResult)
          }
        } catch {
          // Ignore per-chunk network errors; keep listening.
        }
      }, 10000)
    } catch {
      setError(
